...
let AuthService = class AuthService {
    ...
    createToken(authDto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user) {
                throw new common_1.UnauthorizedException('账号错误');
            }
            ...
            return {
                expires_in: config_1.default.jwt.signOptions.expiresIn,
    ...
    validateUser(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userRepository.find({ email: payload.email });
        });
    }
};
